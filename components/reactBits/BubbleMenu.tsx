...
export default function BubbleMenu({
  ...
  return (
    <>
      {/* internal styles kept as before for menu behaviour */}
       <style>{`
      ...
      {/* container (inline) — the parent has pointer-events-none so button must enable pointer-events */}
      <div className={containerClassName} style={style} aria-label="Bubble menu container">
        <button
          type="button"
          className={[
      ...
      {showOverlay && (
        <div
          ...
          className={[
            ...
            "pointer-events-none",
            "z-[1000]",
            ` ${bgBlur ? 'backdrop-blur-sm bg-black/20' : ''}`
            // ------------------------------------------------------------------------------------------------------
          ].join(" ")}
